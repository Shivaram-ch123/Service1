...
public class EmployeeController { 
	...
	@GetMapping("/all")                
	public ResponseEntity<Iterable<EmployeeDto>> getSingleEmployee(){
	...
	public ResponseEntity<EmployeeDto> getEmployeeByEmpCodeAndCompanyName(
	    ...
	    EmployeeDto response = employeeService
	            .getEmployeeByEmpCodeAndCompanyName(empCode, companyName);
